...
<div class="container-content-page container-back">
	<div class="row">
		...
		<div class="col-sm-6 col-md-6">
			...
			<input type="text" hidden="true" value="{{$idThing}}" name="idThing">
			...
			<input type="text" name="nombre" id="nom" autocomplete="off" class="input-line-yellow form-control" value="{{$thing->thing_name}}" placeholder="Mesa de Jardín">
			...
			<input type="text" name="descripcion" id="des" autocomplete="off" class="input-line-yellow form-control" value="{{$thing->description}}" placeholder="Pequeña mesa de jardin de madera">
			...
			<!-- foto -->
			<div id="inputFoto">
            <input type="file" name="foto_up" id="foto" data-initial-preview="{{isset($thing->photo) ? Storage::url("$thing->photo") : ''}}" accept="image/*"/>
			</div>
			<!-- foto -->
